<?php
// Version of survey map with survey closed (redirects here effective 2021-01-01).
include("config.php");
...
<body>
    ...
    <div class="message hint">
        <div class="hint-body">
            <p><b>The survey is now closed.</b></p>
            <p>You can still browse around. Stay tuned for the Bus Stop Census findings!</p>
        </div>
