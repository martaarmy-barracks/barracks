...
function initMap() {
	...
	function markerClicked(e) {
		var jqQr = $("#qrcode");
		if (jqQr.length > 0) {
			jqQr[0].title = jqQr[0].src = "admin/bus-sign/qr.php?p=http://barracks.martaarmy.org/qr.php%3Fs=" + e.target.stopid;
		}
	}
...
function getStopDescription(marker) {
	...
	+ " | <a target='_blank' href='http://barracks.martaarmy.org/stopinfo.php?sid=" + marker.stopid + "'>Arrivals</a>"
