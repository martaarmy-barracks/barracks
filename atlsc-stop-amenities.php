...
<body>
    ...
    <h2>
        <sup>🚦</sup><svg width="24" height="24" viewBox="0 0 105 105" xmlns="http://www.w3.org/2000/svg">
            <g>
    ...
    <p>All stops have safe pedestrian crossings in the vicinity, most with traffic lights, visible markings, and tactile strips for people with vision impairments. Still, be on the lookout for angry drivers.</p>
