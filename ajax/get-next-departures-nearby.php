...
echo getNextDepartures($lat, $lon, $radius, $date_as_int, $service_id);

function getNextDepartures($lat, $lon, $radius, $hhmm, $service_id) {
	global $_DB;
	init_db();
...
EOT;
	...
	$output = "{\"lat\": \"" . $lat . "\", \"lon\": \"" . $lon . "\", \"radius\": \"" . $radius . "\", \"reqtime\": \"" . $hhmm . "\", \"service_id\": \"" . $service_id
